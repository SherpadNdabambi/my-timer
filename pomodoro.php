...
<body onload="onPageLoad()" onunload="onPageUnload()">
	...
	<div class="centered">
		...
		<form id="sessionForm" action="files/logSession.php" method="post">
			...
			<input id="task_name" name="task_name" onblur="this.placeholder = 'Unnamed Task'" onfocus="this.placeholder = ''" placeholder="Unnamed Task">
	...
	<script type="text/javascript" src="files/scripts/pomodoro.js"></script>
